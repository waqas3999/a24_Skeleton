class Akhbar {
  ...
  static List<String> sportscore = [
    'في الامس',
    'غدا',
    'اليوم',
  ];
  static List<String> missthis = [
    'الدوري الممتاز',
    'كرة القدم الأحدث',
    'EFLيسلط الضوء على ',
    'مياميGP يجب',
  ...
  static List<String> weektab = ['االأكثر قراءة', 'مواضيع شائعة'];
}
