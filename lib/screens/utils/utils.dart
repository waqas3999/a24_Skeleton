...
Color score_midcolor = const Color(0xFF535353);
Color app_redcolor = const Color(0xFFD62B47);
Color app_menuscreen_color = const Color(0xFF1D253C);
Color sport_main_tab_color = const Color(0xFF0E0E0E);
...
Color datepicker = const Color(0xFFEFEDED);
Color tab_unselectedcolor = const Color(0xFFA7A7A7);
Color container_home_color = const Color(0xFFF7F7F7);
Color botttombar_color = const Color(0xFFF7F7F7);
Color camera_bg_Color = const Color(0xFF234DC2);
TextStyle red_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: app_redcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 63.5 * (-0.5 / 100));
TextStyle slider_detailText = GoogleFonts.openSans(
    fontSize: 14,
...
TextStyle slider_nameStyle = GoogleFonts.openSans(
    fontSize: 16,
...
TextStyle sport_score = GoogleFonts.openSans(
    fontSize: 16,
    // decorationStyle:TextDecorationStyle.wavy,
    fontWeight: FontWeight.w700,
...
TextStyle heading2 = GoogleFonts.openSans(
    ...
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (1 / 100));
TextStyle bottom_textStyle = GoogleFonts.openSans(
    fontSize: 17,
    fontWeight: FontWeight.w500,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 20 * (3 / 100));
TextStyle selected_tabStyle = GoogleFonts.openSans(
  fontSize: 17,
  fontWeight: FontWeight.w500,
  color: app_Bluecolor,
  fontStyle: FontStyle.normal,
...
TextStyle login = GoogleFonts.openSans(
  fontSize: 22,
  fontWeight: FontWeight.w600,
  color: app_Blackcolor,
  fontStyle: FontStyle.normal,
...
TextStyle signup = GoogleFonts.openSans(
  fontSize: 17,
...
TextStyle textfield_style = GoogleFonts.openSans(
  fontSize: 22,
  fontWeight: FontWeight.w700,
  color: app_Blackcolor,
  //fontStyle: FontStyle.normal,
...
TextStyle or = GoogleFonts.openSans(
    fontSize: 25,
    // decorationStyle:TextDecorationStyle.wavy,
    fontWeight: FontWeight.w700,
    color: app_Blackcolor,
    ...
    letterSpacing: 20 * (3 / 100));
TextStyle account = GoogleFonts.openSans(
    fontSize: 19,
    fontWeight: FontWeight.w700,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    decoration: TextDecoration.none,
    letterSpacing: 20 * (3 / 100));
TextStyle share = GoogleFonts.openSans(
    fontSize: 19,
    // decorationStyle:TextDecorationStyle.wavy,
    fontWeight: FontWeight.w700,
    color: app_redcolor,
    ...
    letterSpacing: 20 * (3 / 100));
TextStyle heading8 = GoogleFonts.openSans(
    fontSize: 17,
    fontWeight: FontWeight.w500,
    color: app_menu_listsepratercolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 63.5 * (-0.5 / 100));
TextStyle matchlist_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
...
TextStyle txtfield_menu = GoogleFonts.openSans(
    fontSize: 17,
    fontWeight: FontWeight.w600,
    color: app_menu_textcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (2 / 100));
TextStyle txtfield_signup = GoogleFonts.openSans(
    fontSize: 22,
    fontWeight: FontWeight.w500,
    color: app_menu_textcolor,
    fontStyle: FontStyle.normal,
...
TextStyle listtile_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: app_Whitecolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 63.5 * (2 / 100));
TextStyle slider_headertext = GoogleFonts.openSans(
    fontSize: 22,
    fontWeight: FontWeight.w600,
    color: app_Whitecolor,
    fontStyle: FontStyle.normal,
...
TextStyle home_heading1 = GoogleFonts.openSans(
    fontSize: 30,
    fontWeight: FontWeight.w600,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
...
TextStyle goal_blue_style = GoogleFonts.openSans(
    fontSize: 30,
    fontWeight: FontWeight.w500,
    color: app_Bluecolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 63.5 * (3 / 100));
TextStyle goal_red_style = GoogleFonts.openSans(
    fontSize: 30,
    fontWeight: FontWeight.w600,
    color: app_redcolor,
    fontStyle: FontStyle.normal,
...
TextStyle goal_white_style = GoogleFonts.openSans(
    fontSize: 30,
    fontWeight: FontWeight.w600,
    color: app_Whitecolor,
    fontStyle: FontStyle.normal,
...
TextStyle single_text = GoogleFonts.openSans(
    fontSize: 18,
    fontWeight: FontWeight.w500,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
...
TextStyle ssingle_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 20.4 * (3 / 100));

TextStyle home_heading2 = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
...
TextStyle hottest_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: app_Bluecolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (3 / 100));
TextStyle headingblue_text = GoogleFonts.openSans(
    fontSize: 25,
    fontWeight: FontWeight.w700,
    color: app_Bluecolor,
    fontStyle: FontStyle.normal,
...
TextStyle scoremain_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w500,
    color: app_Whitecolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (0 / 100));
TextStyle listtext = GoogleFonts.openSans(
    height: 1.2,
    fontSize: 15,
    fontWeight: FontWeight.w600,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (3 / 100));
TextStyle vedio_text = GoogleFonts.openSans(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 63.5 * (-0.5 / 100));
TextStyle message_text = GoogleFonts.openSans(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: app_menu_textcolor,
    fontStyle: FontStyle.normal,
    letterSpacing: 18.4 * (1 / 100));
TextStyle slider_text = GoogleFonts.openSans(
    fontSize: 13,
    fontWeight: FontWeight.w500,
    color: app_Blackcolor,
    fontStyle: FontStyle.normal,
